...
public class Day5_1 {
    ...
    public static int runIntCode(int[] intCodeList, int input1, int input2) throws Exception
    {
        int inputOrder = 0;
        ...
        for (int i = 0; i < intCodeList.length; )
        {
            ...
            switch (opCode)
            {
                ...
                case 3:
                    if (inputOrder == 0)
                    {
                        intCodeList[intCodeList[i + 1]] = input1;
                        inputOrder = 1;
                    }
                    else
                    {
                        intCodeList[intCodeList[i + 1]] = input2;
                    }
